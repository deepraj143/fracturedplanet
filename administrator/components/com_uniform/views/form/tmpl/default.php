		...
		<div class="jsn-pane jsn-bgpattern pattern-sidebar">
				...
				<div id="form-design-content" class="jsn-section-content <?php echo !empty($this->_item->form_theme) ? $this->_item->form_theme : "jsn-style-light"; ?>">
						<div id="form-container" class="jsn-layout">
								...
								<a class="jsn-add-more" id="jsn-add-container" href="javascript:void(0);">Add Container</a>
								...
								<div class="ui-sortable jsn-sortable-disable">
										<div class="form-actions ui-state-default jsn-iconbar-trigger">
												<div class="<?php echo $buttonPosition;?>">
														...
														{
																?>
																<button class="<?php echo $buttonSubmitColor;?> jsn-form-submit" onclick="return false;"><?php echo $this->_item->form_btn_submit_text ? JText::_($this->_item->form_btn_submit_text) : JText::_('SUBMIT'); ?></button>
																<?php
														}
														else
														{
																?>
																<button onclick="return false;" class="<?php echo $buttonPrevColor;?> jsn-form-prev hide"><?php echo $this->_item->form_btn_prev_text ? JText::_($this->_item->form_btn_prev_text) : JText::_('PREV'); ?></button>
																<button onclick="return false;" class="<?php echo $buttonNextColor;?> jsn-form-next hide"><?php echo $this->_item->form_btn_next_text ? JText::_($this->_item->form_btn_next_text) : JText::_('NEXT'); ?></button>
																<button class="<?php echo $buttonSubmitColor;?> jsn-form-submit hide" onclick="return false;"><?php echo $this->_item->form_btn_submit_text ? JText::_($this->_item->form_btn_submit_text) : JText::_('SUBMIT'); ?></button>
																<?php
														}
														?>
