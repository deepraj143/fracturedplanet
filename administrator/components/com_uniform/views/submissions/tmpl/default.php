			...
			<div class="popover bottom">
			    ...
			    <div class="popover-content">
				    ...
				    for ($i = 0; $i < count($fieldIdentifier); $i++)
				    {
					    ...
					    $items .= '<li class="' . $styleClass[$i] . ' jsn-item ui-state-default"><label class="checkbox"><input ' . $checked . ' type="checkbox" title="' . $fieldTitle[$i] . '" name="field[]" value="' . $fieldIdentifier[$i] . '">' . JText::_($fieldTitle[$i]) . '</label></li>';
				    }
				    ?>
