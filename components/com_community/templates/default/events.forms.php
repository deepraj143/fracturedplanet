			...
			<li id="event-start-datetime" class="has-seperator">
				...
				<div class="form-field">
					<span class="jomNameTips" title="<?php echo JText::_('COM_COMMUNITY_EVENTS_START_TIME_TIPS'); ?>">
						<?php
                                                    echo CBCalendar::createDatePicker(
                                                            //Date picker id 
                                                            'startdatepicker',
                                                            array('class' => 'span2 required input-medium', 'size' => '10', 'style'=>'width:auto;' , 'type' => 'text', 'id' => 'startdate', 'name'=> 'startdate', 'readonly' => 'true'),
                                                            //Date format
                                                            'Y-m-d',
                                                            //Options
                                                            'format: "yyyy-mm-dd",
                                                            ...
                                                            //View mode
                                                            'days');
                                                    echo CBCalendar::addEvent('startdatepicker', 'changeDate', '
                                                        var startDateTmp = new Date(joms.jQuery(\'#startdate\').val());
                                                        bdp_enddatepicker.datepicker(\'setValue\', startDateTmp);
                                                    ');
                                                ?>
						<span id="start-time">
					...
					<span class="jomNameTips" title="<?php echo JText::_('COM_COMMUNITY_EVENTS_END_TIME_TIPS'); ?>">
						<?php
                                                    echo CBCalendar::createDatePicker(
                                                                ...
                                                                'enddatepicker',
                                                                //Input properties
                                                                array('class' => 'span2 required input-medium', 'size' => '10', 'style'=>'width:auto;', 'type' => 'text', 'id' => 'enddate', 'name'=> 'enddate', 'readonly' => 'true'),
                                                                //Format
                                                                'Y-m-d',
                                                                //Options
                                                                'format: "yyyy-mm-dd",
                                                                 autoclose: true,
                                                                 onRender: function(date) {
                                                                    var startDate = new Date(joms.jQuery(\'#startdate\').val());
					...
					<span class="jomNameTips" title="<?php echo JText::_('COM_COMMUNITY_EVENTS_REPEAT_END_TIPS'); ?>">
						<?php
                                                        ...
                                                        echo CBCalendar::createDatePicker(
                                                            ...
                                                            'repeatenddatepicker',
                                                            //Input properties
                                                            array('class' => 'span2 required input-medium', 'size' => '10', 'type' => 'text', 'style'=>'width:auto;', 'id' => 'repeatend', 'name'=> 'repeatend', 'value'=> $repeatend, 'readonly' => 'true'));
                                                        echo CBCalendar::addEvent('repeatenddatepicker', 'changeDate', '
                                                             updateEventDate();
                                                        ');
                                                ?>
						<script type="text/javascript">
